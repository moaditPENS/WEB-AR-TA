...
<head>
	...
	<title>Database Informasi Peralatan Lab</title>
	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <div class="container-fluid">
		    <a class="navbar-brand" href="index.php">Dashboard Informasi</a>
					...
					<div class="card-body">
                       ...
                       <a href="uploads/files/<?=$book['file']?>"
                        ...
                        <a href="uploads/files/<?=$book['file']?>"
						  ...
						  <a href="index-1.html" class="btn btn-danger">Catalog AR</a>
						  <a href="index-2.html" class="btn btn-info">Catalog 3D</a>
					</div>
				</div>
				<?php } ?>
			</div>
